...
class TestTairBloom:
    ...
    def test_bf_add_maybe_exist(self):
        t = get_tair_client()
        key = "key_" + str(uuid.uuid4())
        item = "item_" + str(uuid.uuid4())
    ...
    def test_bf_insert_nocreate(self):
        t = get_tair_client()
        key = "key_" + str(uuid.uuid4())
        item1 = "item_" + str(uuid.uuid4())
        item2 = "item_" + str(uuid.uuid4())
