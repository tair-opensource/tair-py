...
class TestTairRoaring:
    ...
    def test_tr_appendintarray(self, t):
        key = "key_" + str(uuid.uuid4())
        offsets = [9, 10]
    ...
    def test_tr_setintarray(self, t):
        key = "key_" + str(uuid.uuid4())
        offsets = [2, 4, 5, 6]
    ...
    def test_tr_setbitarray(self, t):
        key = "key_" + str(uuid.uuid4())
    ...
    def test_tr_bitopcard_and(self, t):
        key1 = "key_" + str(uuid.uuid4())
        key2 = "key_" + str(uuid.uuid4())
    ...
    def test_tr_bitopcard_or(self, t):
        key1 = "key_" + str(uuid.uuid4())
        key2 = "key_" + str(uuid.uuid4())
    ...
    def test_tr_bitopcard_xor(self, t):
        key1 = "key_" + str(uuid.uuid4())
        key2 = "key_" + str(uuid.uuid4())
    ...
    def test_tr_bitopcard_not(self, t):
        key = "key_" + str(uuid.uuid4())

        assert t.tr_setbits(key, [0, 2, 3, 5]) == 4
        assert t.tr_bitopcard("NOT", (key,)) == 2

    def test_tr_bitopcard_diff(self, t):
        key1 = "key_" + str(uuid.uuid4())
        key2 = "key_" + str(uuid.uuid4())
    ...
    def test_tr_optimize(self, t):
        key = "key_" + str(uuid.uuid4())

        assert t.tr_setbits(key, [0, 2, 3, 5]) == 4
        assert t.tr_optimize(key)

    def test_tr_bitcount(self, t):
        key = "key_" + str(uuid.uuid4())
